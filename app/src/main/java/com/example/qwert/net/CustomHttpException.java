...
import com.example.qwert.app.utils.ActivityStackManager;
import com.example.qwert.frame.MainActivity;
import com.example.qwert.view.activity.LoginActivity;
...
public class CustomHttpException extends RuntimeException {
    ...
    private String getCustomHttpException(int code) {
        ...
        switch (code) {
            ...
            case 401:
                BoxApplication.getContext().startActivity(new Intent(BoxApplication.getContext(), LoginActivity.class));
